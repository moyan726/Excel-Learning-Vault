...
![1.data-validation-sequence-dropdown](E:\桌面文件\Excel\image\1.data-validation-sequence-dropdown.png)
...
![2.name-box-select-range](E:\桌面文件\Excel\image\2.name-box-select-range.png)
...
![3.remove-duplicates-region-province](E:\桌面文件\Excel\image\3.remove-duplicates-region-province.png)
...
![4.conditional-format-icon-set-mom](E:\桌面文件\Excel\image\4.conditional-format-icon-set-mom.png)

字体调整不做演示，这里只展示样式调整--- 加入图标



![5.conditional-format-positive-green-font](E:\桌面文件\Excel\image\5.conditional-format-positive-green-font.png)
...
![6.conditional-format-data-bar-sales-amount](E:\桌面文件\Excel\image\6.conditional-format-data-bar-sales-amount.png)
...
![7.custom-number-format-mom-display](E:\桌面文件\Excel\image\7.custom-number-format-mom-display.png)
...
![8.final-sales-report-result](E:\桌面文件\Excel\image\8.final-sales-report-result.png)
