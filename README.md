...
课程标题：**【课程4.0】Excel 大厂报表｜仪表板｜数据透视表｜Power Query 数据处理**

该目录收录本课程 **00:00:00 ~ 00:28:00** 时间段的学习内容，包括笔记、截图与练习文件。
...
本仓库内容主要用于个人学习记录与公开交流。除特别说明外，仓库中由本人原创整理的文字内容欢迎非商业用途下引用与学习交流，转载请注明出处，未经允许请勿用于商业用途。  
课程视频、原始资料及相关素材的版权归原作者所有。
